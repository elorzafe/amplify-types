...
declare class API {
    /** HTTP GET METHOD */
    static get<ResponseType extends unknown>(params: APIParam, init?: FetchOptions): Promise<APIResponse<ResponseType>>;
    /** HTTP HEAD METHOD */
    head: <T extends APIResponse = APIResponse>(params: APIParam, init?: FetchOptions) => Promise<T>
    /** HTTP DELETE METHOD */
    delete: <T extends APIResponse = APIResponse>(params: APIParam, init?: FetchOptions) => Promise<T>
    /** HTTP OPTIONS METHOD */
    options: <T extends APIResponse = APIResponse>(params: APIParam, init?: FetchOptions) => Promise<T>
    /** HTTP PUT METHOD */
    ...
    /** Cancel HTTP Request */
    static cancel: (request: Promise<unknown>, message: string) => boolean
